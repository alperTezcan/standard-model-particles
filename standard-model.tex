...
\draw[rounded corners=5,fill=cbosons,fill opacity=0.5] (3.5 + 0.1, -3 - 0.3) rectangle (3.5 + 1, -4 - 0.2) node[pos=0.5,opacity=1,xshift=-3,yshift=0] {\LARGE $W$} \leg{80.38 G}{\phantom{{$\scriptscriptstyle +$}}$\pm1$}{\phantom{{$\scriptscriptstyle +$}}1}{$W$ boson};
